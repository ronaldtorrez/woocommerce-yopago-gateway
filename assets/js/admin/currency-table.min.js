...
/*!
           ...
           */
s=function(e){var t,n,o=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],i="onwheel"in document||document.documentMode>=9?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],r=Array.prototype.slice;if(e.event.fixHooks)for(var s=o.length;s;)e.event.fixHooks[o[--s]]=e.event.mouseHooks;var a=e.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener)for(var t=i.length;t;)this.addEventListener(i[--t],l,!1);else this.onmousewheel=l;e.data(this,"mousewheel-line-height",a.getLineHeight(this)),e.data(this,"mousewheel-page-height",a.getPageHeight(this))},teardown:function(){if(this.removeEventListener)for(var t=i.length;t;)this.removeEventListener(i[--t],l,!1);else this.onmousewheel=null;e.removeData(this,"mousewheel-line-height"),e.removeData(this,"mousewheel-page-height")},getLineHeight:function(t){var n=e(t),o=n["offsetParent"in e.fn?"offsetParent":"parent"]();return o.length||(o=e("body")),parseInt(o.css("fontSize"),10)||parseInt(n.css("fontSize"),10)||16},getPageHeight:function(t){return e(t).height()},settings:{adjustOldDeltas:!0,normalizeOffset:!0}};function l(o){var i,s=o||window.event,l=r.call(arguments,1),d=0,p=0,h=0,f=0,g=0;if((o=e.event.fix(s)).type="mousewheel","detail"in s&&(h=-1*s.detail),"wheelDelta"in s&&(h=s.wheelDelta),"wheelDeltaY"in s&&(h=s.wheelDeltaY),"wheelDeltaX"in s&&(p=-1*s.wheelDeltaX),"axis"in s&&s.axis===s.HORIZONTAL_AXIS&&(p=-1*h,h=0),d=0===h?p:h,"deltaY"in s&&(d=h=-1*s.deltaY),"deltaX"in s&&(p=s.deltaX,0===h&&(d=-1*p)),0!==h||0!==p){if(1===s.deltaMode){var m=e.data(this,"mousewheel-line-height");d*=m,h*=m,p*=m}else if(2===s.deltaMode){var v=e.data(this,"mousewheel-page-height");d*=v,h*=v,p*=v}if(i=Math.max(Math.abs(h),Math.abs(p)),(!n||i<n)&&(n=i,u(s,i)&&(n/=40)),u(s,i)&&(d/=40,p/=40,h/=40),d=Math[d>=1?"floor":"ceil"](d/n),p=Math[p>=1?"floor":"ceil"](p/n),h=Math[h>=1?"floor":"ceil"](h/n),a.settings.normalizeOffset&&this.getBoundingClientRect){var y=this.getBoundingClientRect();f=o.clientX-y.left,g=o.clientY-y.top}return o.deltaX=p,o.deltaY=h,o.deltaFactor=n,o.offsetX=f,o.offsetY=g,o.deltaMode=0,l.unshift(o,d,p,h),t&&clearTimeout(t),t=setTimeout(c,200),(e.event.dispatch||e.event.handle).apply(this,l)}}function c(){n=null}function u(e,t){return a.settings.adjustOldDeltas&&"mousewheel"===e.type&&t%120==0}e.fn.extend({mousewheel:function(e){return e?this.bind("mousewheel",e):this.trigger("mousewheel")},unmousewheel:function(e){return this.unbind("mousewheel",e)}})},"function"==typeof t.define&&t.define.amd?t.define("jquery-mousewheel",["jquery"],s):n.exports=s,t.define("jquery.select2",["jquery","jquery-mousewheel","./select2/core","./select2/defaults","./select2/utils"],(function(e,t,n,o,i){if(null==e.fn.select2){var r=["open","close","destroy"];e.fn.select2=function(t){if("object"==typeof(t=t||{}))return this.each((function(){var o=e.extend(!0,{},t);new n(e(this),o)})),this;if("string"==typeof t){var o,s=Array.prototype.slice.call(arguments,1);return this.each((function(){var e=i.GetData(this,"select2");null==e&&window.console&&console.error&&console.error("The select2('"+t+"') method was called on an element that is not using Select2."),o=e[t].apply(e,s)})),r.indexOf(t)>-1?this:o}throw new Error("Invalid arguments for Select2: "+t)}}return null==e.fn.select2.defaults&&(e.fn.select2.defaults=o),n})),{define:t.define,require:t.require}}(),o=t.require("jquery.select2");return e.fn.select2.amd=t,o},(n=i).exports?n.exports=function(t,n){return void 0===n&&(n="undefined"!=typeof window?e:e(t)),o(n),n}:o(jQuery));const r=()=>e("#mainform :input").first().trigger("change");function s(e,t,n,o){const i=(r=20,s=200,Math.floor(Math.random()*(s-r+1))+r);var r,s;const a=i*t,l="fixed"===o?n:a*(n/100),c=a+l;return`\n    <h4>${wc_yopago_params.ex_title.replace("{from}",e.code).replace("{to}","BOB")}</h4>\n    <p><strong>${wc_yopago_params.ex_assumptions}</strong></p>\n    <ul>\n      <li>${wc_yopago_params.ex_site_currency}: ${e.code} => ${e.symbol}</li>\n      <li>${wc_yopago_params.ex_rate}: 1 ${e.code} = ${t.toFixed(4)} BOB</li>\n      <li>${"fixed"===o?wc_yopago_params.ex_fee_fixed:wc_yopago_params.ex_fee_percent}: \n      ${n}${"fixed"===o?" BOB":"%"}\n      </li>\n      <li>${wc_yopago_params.ex_original}: ${i.toFixed(2)} ${e.code}</li>\n    </ul>\n    <p><strong>${wc_yopago_params.ex_calc}</strong></p>\n    <table class='widefat'>\n      <thead>\n          <tr>\n              <th>${wc_yopago_params.ex_concept}</th>\n              <th>${wc_yopago_params.ex_value}</th>\n          </tr>\n      </thead>\n      <tbody>\n        <tr>\n            <td>${wc_yopago_params.ex_c_original.replace("{from}",e.code)}</td>\n            <td>${i.toFixed(2)} ${e.code}</td>\n        </tr>\n        <tr>\n            <td>${wc_yopago_params.ex_c_rate}</td>\n            <td>1 ${e.code} = ${t.toFixed(4)} BOB</td>\n        </tr>\n        <tr>\n            <td>${wc_yopago_params.ex_c_subtotal.replace("{to}","BOB")}</td>\n            <td>${a.toFixed(2)} BOB</td>\n        </tr>\n        <tr>\n            <td>${"fixed"===o?wc_yopago_params.ex_fee_fixed:wc_yopago_params.ex_fee_percent}</td>\n            <td>${l.toFixed(2)} BOB</td>\n        </tr>\n        <tr>\n            <td>\n                <strong>${wc_yopago_params.ex_c_total.replace("{to}","BOB")}</strong>\n            </td>\n            <td>\n                <strong>${c.toFixed(2)} BOB</strong>\n            </td>\n        </tr>\n      </tbody>\n    </table>\n    <p><strong>${wc_yopago_params.ex_result}</strong></p>\n    <p>\n    ${wc_yopago_params.ex_result_text.replace("{total}",c.toFixed(2)).replace("{to}","BOB")}\n    </p>\n  `}function a(t,n){if(!t.id)return t.text;const o=window.yopagoCurrencies.find((e=>e.code===t.id));return o?n?e(`<span><img src='${o.flag}' class='yopago-flag' /> ${o.name} (${o.code} - ${o.symbol})</span>`):`${o.code} - ${o.name}`:t.text}function l(e){e.select2({width:"100%",placeholder:wc_yopago_params.select_currency,allowClear:!1,templateResult:e=>a(e,!0),templateSelection:e=>a(e,!1)})}function c(e){const t=e.data("selected");if(e.empty().append(`<option value='' disabled ${t?"":"selected"} hidden></option>`),window.yopagoCurrencies.forEach((n=>{e.append(new Option(`${n.name} (${n.code} - ${n.symbol})`,n.code,!1,n.code===t))})),l(e),t&&e.val(t).trigger("change.select2"),t){e.val(t).trigger("change.select2");const n=window.yopagoCurrencies.find((e=>e.code===t)),o=n&&null!=n.rateToBOB?n.rateToBOB:1;e.closest("tr").find('input[name*="[rate]"]').val(o.toFixed(4))}e.closest("tr").find(".yopago-example-btn").prop("disabled",!e.val())}function u(){const t=window.yopagoCurrencies?window.yopagoCurrencies.length:0,n=e("#yopago-currency-rates-table tbody tr").not(".empty-row").length;e("#yopago-add-rate").prop("disabled",n>=t)}function d(){const t=e(".yopago-currency-select").map((function(){return e(this).val()})).get().filter(Boolean);e(".yopago-currency-select").each((function(){const n=e(this),o=n.val();n.find("option").prop("disabled",!1),n.find("option").each((function(){const n=this.value;n&&e(this).prop("disabled",n!==o&&t.includes(n))}));const i=n.val();n.select2("destroy"),l(n),i&&n.val(i).trigger("change.select2")}))}function p({$table:t,$addBtn:n,$modal:o,$modalContent:i}){n.on("click",(function(){const e=Date.now(),n=function(e){return`\n  <tr data-index='${e}'>\n    <td>\n      <select class='yopago-currency-select' name='currency_rates[${e}][currency]'>\n        <option value='' disabled selected hidden></option>\n      </select>\n    </td>\n    <td><input  type='number' step='0.0001' name='currency_rates[${e}][rate]' value='1' min='0.0001' required></td>\n    <td><input  type='number' step='0.01'  name='currency_rates[${e}][fee]'  value='0' min='0'     required></td>\n    <td>\n      <select name='currency_rates[${e}][fee_type]'>\n        <option value='fixed'>${wc_yopago_params.fixed}</option>\n        <option value='percent'>${wc_yopago_params.percent}</option>\n      </select>\n    </td>\n    <td>\n      <button type='button' class='button yopago-example-btn' data-index='${e}' disabled>\n        ${wc_yopago_params.view}\n      </button>\n    </td>\n    <td>\n      <button type='button' class='button button-link-delete yopago-remove-rate'>\n        ${wc_yopago_params.remove}\n      </button>\n    </td>\n  </tr>`}(e);t.find("tbody .empty-row").remove(),t.find("tbody").append(n);c(t.find(`tr[data-index="${e}"] .yopago-currency-select`)),d(),u(),r()})),t.on("click",".yopago-remove-rate",(function(){e(this).closest("tr").remove(),0===t.find("tbody tr").length&&t.find("tbody").append(`<tr class='empty-row'><td colspan='6'>${wc_yopago_params.no_currencies}</td></tr>`),d(),u(),r()})),t.on("click",".yopago-example-btn",(function(){const n=e(this).data("index"),r=t.find(`tr[data-index="${n}"]`),a=parseFloat(r.find('input[name*="[rate]"]').val())||1,l=parseFloat(r.find('input[name*="[fee]"]').val())||0,c=r.find('select[name*="[fee_type]"]').val(),u=r.find(".yopago-currency-select").val(),d=window.yopagoCurrencies.find((e=>e.code===u));d&&(i.html(s(d,a,l,c)),o.show())})),t.on("change",".yopago-currency-select",(function(){const t=e(this).closest("tr"),n=e(this).val(),o=window.yopagoCurrencies.find((e=>e.code===n)),i=o&&null!=o.rateToBOB?o.rateToBOB:1;t.find('input[name*="[rate]"]').val(i.toFixed(4)),d(),u(),r()})),e("#yopago-modal-close").on("click",(()=>o.hide()))}window.jQuery=window.$=e,e(document).ready((function(e){const t=e("#yopago-currency-rates-table"),n=e("#yopago-example-modal"),o=e("#yopago-example-text"),i=e("#yopago-add-rate");e.getJSON(wc_yopago_params.currency_data_url).done((function(t){window.yopagoCurrencies=t,e(".yopago-currency-select").each((function(){c(e(this))})),d(),u()})).fail((function(e,t,n){console.error("Failed to load currencies:",t,n),console.log("Attempted path:",wc_yopago_params.currency_data_url)})),p({$table:t,$addBtn:i,$modal:n,$modalContent:o}),e(document).on("change",".yopago-currency-select",(function(){d(),u(),e(this).closest("tr").find(".yopago-example-btn").prop("disabled",!e(this).val()),e("#mainform :input").first().trigger("change")})),e("#mainform").on("submit",(function(){t.find("tbody tr").each((function(){e(this).find(".yopago-currency-select").val()||e(this).remove()}))}))}))}(jQuery);
