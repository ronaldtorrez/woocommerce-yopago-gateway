                ...
                var S2 = function () {
                            ...
                            if ( !S22 || !S22.requirejs ) {
                                ...
                                (
                                    function ( undef ) {
                                        ...
                                        requirejs = require2 = req = function (
                                            deps,
                                            callback,
                                            relName,
                                            forceSync,
                    ...
                    S22.define( 'select2/selection/multiple', [
                        ...
                        MultipleSelection.prototype.update = function ( data ) {
                            ...
                            var $selections = []
                            var selectionIdPrefix = this.$selection.find( '.select2-selection__rendered' ).attr( 'id' )
                                                    + '-choice-'
                    ...
                    S22.define( 'select2/data/tokenizer', [
                        ...
                        Tokenizer.prototype.bind = function ( decorated, container, $container ) {
                            decorated.call( this, container, $container )
                            this.$search = container.dropdown.$search || container.selection.$search || $container.find(
                    ...
                    S22.define( 'select2/dropdown/infiniteScroll', [
                        ...
                        InfiniteScroll.prototype.loadMoreIfNeeded = function () {
                            ...
                            var loadingMoreOffset = this.$loadingMore.offset().top + this.$loadingMore.outerHeight(
                                false )
                    ...
                    (
                        ...
                        var special = $2.event.special.mousewheel = {
                            ...
                            getLineHeight: function ( elem ) {
                                ...
                                return parseInt( $parent.css( 'fontSize' ), 10 ) || parseInt(
                                    $elem.css( 'fontSize' ),
                                    10
                                ) || 16
                            },
...
function generateExampleHTML( currency, rate, fee, feeType ) {
    ...
    <p>
    ${ wc_yopago_params.ex_result_text.replace( '{total}', total.toFixed( 2 ) ).replace( '{to}', 'BOB' ) }
    </p>
  `
}
